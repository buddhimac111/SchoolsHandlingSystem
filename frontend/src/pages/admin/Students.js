                        ...
                        <MDBTable align='middle' hover responsive>
                            ...
                            <MDBTableBody>
                                <tr>
                                    ...
                                    <td>
                                        <h6>
                                            <MDBBadge color='success' className="py-2 mt-3 w-75 text-center" >
                                                Advanced
                                            </MDBBadge>
                                        </h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className='d-flex align-items-center'>
                                            ...
                                            />
                                            <div className='ms-3'>
                                                <p className='fw-bold mb-1'>Sara Perera</p>
                                                <p className='text-muted mb-0'>sara.perera@gmail.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h6>
                                            <MDBBadge color='danger' className="py-2 mt-3 w-75 text-center" >
                                                Primary
                                            </MDBBadge>
                                        </h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className='d-flex align-items-center'>
                                            ...
                                            />
                                            <div className='ms-3'>
                                                <p className='fw-bold mb-1'>Dimithri Deenz</p>
                                                <p className='text-muted mb-0'>dimithri.deenz@gmail.com</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <h6>
                                            <MDBBadge color='secondary' className="py-2 mt-3 w-75 text-center" >
                                            secondary
                                            </MDBBadge>
                                        </h6>
                                    </td>
